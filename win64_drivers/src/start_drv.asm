; start a installed win64 driver
...
start:
	...
	cld
	xchg	rsi,rax     ; parse driver name
	lea	rdi,[driver_name]
...
ErrMsgText4		db	'Error StartService',0
...
StartServiceA		dq	RVA _StartServiceA
